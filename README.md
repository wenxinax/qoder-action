...
| `enable_qoder_github_mcp` | Enable qoder-github MCP Server. | No | `true` |
| `qoder_github_mcp_version` | Version of qoder-github MCP server. | No | `0.1.0-beta` |
| `qodercli_version` | Version of `qodercli` to install. | No | `0.1.10` |
